...
const translations = {
  en: {
    ...
    'about-bio1':    'I am Munirah Almahmoud, an interior designer who enjoys creating modern, elegant and comfortable spaces. My focus is on calm colours, natural materials and simple details to craft balanced, functional environments that make the very most of every corner.',
    'about-bio2':    'From the initial client brief through to the final styling, I bring a disciplined eye and a genuine care for the people who will inhabit each space — believing that great design is not only beautiful, but deeply liveable.',
    'about-bio3':    'My work spans residential, commercial, and hospitality projects, each approached with the same commitment: to translate a client\'s vision into spaces that feel entirely their own.',
  ...
  ar: {
    ...
    'about-bio1':    'أنا منيرة المحمود، مصممة داخلية أسعى دائماً إلى خلق بيئات عصرية وأنيقة ومريحة. أركز على الألوان الهادئة، والمواد الطبيعية، والتفاصيل البسيطة لأصمم فراغات متوازنة ووظيفية تستثمر كل زاوية.',
    'about-bio2':    'من أول لقاء مع العميل وحتى اللمسات الأخيرة للتصميم، أحمل معي عيناً دقيقة واهتماماً حقيقياً بالإنسان الذي سيعيش في هذا الفضاء — إيماناً مني بأن التصميم الرائع ليس جميلاً فحسب، بل يعيش معك.',
    'about-bio3':    'تنوعت مشاريعي بين السكني والتجاري والضيافة، وفي كل منها التزام واحد: أن أحوّل رؤية العميل إلى فراغ يشعر فيه بأنه ملكه تماماً.',
